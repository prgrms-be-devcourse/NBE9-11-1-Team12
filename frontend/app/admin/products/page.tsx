...
//   if (loading) return <div className="p-10 text-center text-lg">로딩 중...</div>;
...
//                   <td className="p-4">
//                     <div className="w-16 h-16 relative overflow-hidden border border-zinc-200">
//                       <Image
...
//                   {/* ✅ 수정 완료: 상품명 영역 (수정 중이 아닐 때만 상세조회 Link 활성화) */}
